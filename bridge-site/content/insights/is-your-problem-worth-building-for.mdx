...
**Not every bottleneck is worth building a custom system for. The businesses that get the most out of custom AI software aren't the ones with the biggest problems — they're the ones with the right problems. This is the framework I use to figure out whether a problem is worth building for, and what makes something a bad fit.**
...
Both are reasonable concerns. Both miss the point.
